...
from skymap import get_skymap #MODULE FOUND HERE https://github.com/skyportal/gwemopt/blob/2b60b391c84e8f067e50fd7b1c9439393c14652a/gwemopt/io/skymap.py#L51
...
def followUp(ep, cands): 
    if cands==[]: 
        ...
        for gw in cands:
            messageSlack(ep, cands, skymapImg(ep, gw))
...
def main(): 
    ...
    while True:
        for message in consumer.consume(timeout=1):
            ...
            for gw in cands: ep[gw.name] = gw.crossmatch_space(coords=ep["ICRS"])
